...
sources:
  repo:
    type: codeup
    name: Natty-Wow
    endpoint: https://codeup.aliyun.com/63aae87b5d24b0d14de63441/natty/natty-wow.git
    branch: main
    certificate:
      type: serviceConnection
      serviceConnection: xjagarmo55a96igs
stages:
  test:
    name: "测试"
    jobs:
        ...
        steps:
          ...
          publish_image:
            ...
            with:
              ...
              dockerRegistry: "registry.cn-hangzhou.aliyuncs.com/weixing_prod/natty"
              dockerTag: ${DATETIME}
              region: "cn-hangzhou"
              serviceConnection: "spjrk6nqazgcmas6"
  deploy:
    name: "部署"
    jobs:
      deploy:
